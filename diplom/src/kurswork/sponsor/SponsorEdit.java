...
public class SponsorEdit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        outB.setBackground(new java.awt.Color(253, 193, 0));
        outB.setFont(new java.awt.Font("Century Gothic", 3, 14)); // NOI18N
        outB.setText("Выход");
        outB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                outBActionPerformed(evt);
            }
        });
        ...
        mainP.add(loginB, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 440, 200, -1));
        ...
        nameL.setText("Редактирование спонсора");
    ...
    private void outBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_outBActionPerformed
        new HomeF().setVisible(true);
        this.dispose();
    }//GEN-LAST:event_outBActionPerformed
    ...
    private javax.swing.JButton outB;
